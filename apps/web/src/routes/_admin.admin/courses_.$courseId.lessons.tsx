  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Managing lessons for course: {courseId}</p>
      </div>
      <Panel>
        <PanelTitle>Lessons List</PanelTitle>
        <p className="text-sm text-muted-foreground mt-4">Placeholder for Lesson list, drag-to-reorder, Add/Edit/Delete lesson form with video upload.</p>
      </Panel>
    </div>
  )
}
