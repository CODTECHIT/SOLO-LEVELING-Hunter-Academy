...
function SupportPage() {
  ...
  const faqs = [
    { q: "How do I access my purchased courses?", a: "Go to your Profile and click on the 'Purchases' tab to see all your unlocked pathways." },
    { q: "What is the refund policy?", a: "We offer a 30-day refund policy for all courses if you haven't completed more than 20% of the content. You can request a refund from the Refunds section in your profile." },
    { q: "How do I level up my Hunter Rank?", a: "Completing lessons, modules, and quizzes grants you XP. Accumulate enough XP to advance to the next rank." },
    { q: "Can I download the videos for offline viewing?", a: "Currently, our content is only available online to ensure the best possible learning experience and to track your progress accurately." },
  ];
      ...
      <div className="mx-auto max-w-4xl space-y-12 pb-12">
        ...
        <section>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="rounded-xl border border-border bg-surface overflow-hidden transition-all hover:border-border/80">
                <button
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Panel accent="purple">
            ...
            <form className="space-y-4 mt-4" onSubmit={(e) => { e.preventDefault(); alert("Message sent successfully!"); }}>
              <div>
          ...
          <div className="space-y-6">
            <Panel accent="cyan" className="h-full flex flex-col justify-center text-center p-8">
              ...
              <h3 className="font-display text-xl font-bold text-foreground mb-2">Instant Support</h3>
              <p className="text-muted-foreground text-sm mb-6">
                Get immediate assistance from our support team via WhatsApp. We typically reply within minutes.
              </p>
              <a
            ...
            <Panel accent="slate" className="text-center p-6">
              ...
              <a href="mailto:support@sololeveling.academy" className="text-neon-cyan hover:underline mt-1 block">
